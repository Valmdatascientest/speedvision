...
Un second smoke test positif utilise `cli_inference_result.jpg` du dépôt du modèle plaques, révision `b1f410f7c2dbe518225238b36b137e679a921ce4`. Cette image contient déjà des annotations de l’auteur et peut appartenir à ses données : elle vérifie uniquement la chaîne ROI et ne participe à aucun calcul de rappel indépendant. Elle est téléchargée hors Git, avec hash vérifié.
